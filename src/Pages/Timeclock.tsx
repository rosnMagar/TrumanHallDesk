  ...
  return (
    <AppShell header={{ height: 56 }} footer={{ height: 80 }} padding={0}>
      ...
      <AppShell.Main bg="gray.1">
        <Stack p="xl" maw={720} mx="auto" gap="lg">
          ...
          <Paper withBorder shadow="xs" p="xl" radius="md">
            ...
            <Stack gap="md">
              ...
              {message ? (
                <Alert color={message.type === 'ok' ? 'teal' : 'red'} title={message.type === 'ok' ? 'Recorded' : 'Cannot punch'}>
                  {message.text}
                </Alert>
              ) : null}
      ...
      <AppShell.Footer bg="gray.2" p="md">
        <Group justify="center">
          <Text size="sm" c="dimmed">
            {trimmedBanner
              ? isClockedIn
                ? `Banner ${trimmedBanner} — currently clocked in`
                : `Banner ${trimmedBanner} — currently clocked out`
              : 'Enter a Banner ID to clock in or out'}
          </Text>
        </Group>
      </AppShell.Footer>
    </AppShell>
